// Modified from main93.cc by Mikael Mieskolainen <m.mieskolainen@imperial.ac.uk>
//
// - RIVET dependence commented out
...
int main(int argc, char* argv[]) {
  ...
  if (hepmc) {
    hepmcIO = new HepMC::IO_GenEvent((out == "" ? "pythia.hepmc" : out + ".hepmc"), ios::out);
  }
